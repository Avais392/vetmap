...
class HomeScreen extends Component {
  ...
  _onPress = () => {
    ...
    RNFetchBlob.config({fileCache: true})
      .fetch('GET', 'https://firebasestorage.googleapis.com/v0/b/vetmap-eb11e.appspot.com/o/uploads%2F-MbweKAA-I9mEBkksV6F.png?alt=media&token=201dbe5b-84f4-44e8-90af-759599bc14a2')
      .then((resp) => {
    ...
    return (
     <View  style={{width:'100%',flex:1,height:height}}>
       <TouchableOpacity onPress={this._onPress}>
        ...
        <Image style={{height:300,width:300}} source={{uri:'file:///storage/emulated/0/Pictures/PhotoEditorSDK/IMG_20210531_072555.jpg'}}></Image>
        { true && 
<>
